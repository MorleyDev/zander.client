...
class GetBranchTests extends SpecTest {
        ...
        using(this.start()) {
          testHarness =>
            ...
            val expectedFiles = Seq[String](
              "include/" + GenNative.genAlphaNumericString(1, 20),
            ...
            testHarness
              ...
              .whenGettingBranch(compiler = compiler, mode = mode, branch = GenNative.genAlphaNumericString(3,20))
